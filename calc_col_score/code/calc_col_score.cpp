...
int main(int argc, char *argv[]) { //msa_set_score
  ...
  string usage="\nmsa_set_score v2.01\n\nUsage:\n\
  \n    calc_col_score  file_with_MSA_to_score   output_files_prefix   -m file_with_a_single_alternative_MSA                \n  Or\
  \n    calc_col_score  file_with_MSA_to_score   output_files_prefix   -d directory_with_multiple_alternative_MSA_files     \n  Or\
  \n    calc_col_score  file_with_MSA_to_score   output_files_prefix   -f file_with_a_list_of_multiple_alternative_MSA_files\n\
